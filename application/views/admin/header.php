...
<header class="header">
    <div class="page-brand">
        <a class="link" href="<?php echo base_url('home') ?>">
            <span class="brand">
                <?php echo $rows['nama_website'] ?>
            </span>
            <span class="brand-mini">RC</span>
        </a>
    </div>
        ...
        <ul class="nav navbar-toolbar">
            ...
            <li class="dropdown dropdown-user">
                <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                    <img src="<?php echo base_url('assets/foto_user/'.$foto) ?>" />
                    <span></span><?php echo $log['username'] ?><i class="fa fa-angle-down m-l-5"></i></a>
