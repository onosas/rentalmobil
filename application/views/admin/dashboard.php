    ...
    <div class="row">
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-success color-white widget-stat">
                <div class="ibox-body">
                    <?php $jmla = $this->db->get('booking')->num_rows(); ?>
                    <h2 class="m-b-5 font-strong"><?php echo $jmla; ?></h2>
                    <div class="m-b-5">RENTAL</div><i class="ti-car widget-stat-icon"></i>
                    <div><i class="fa fa-level-up m-r-5"></i><small><?php echo $jmla*10/100; ?>% higher</small></div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-info color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong"><?php echo $total_income*1/100; ?> k</h2>
                    <div class="m-b-5">INCOME</div><i class="ti-bar-chart widget-stat-icon"></i>
                    <div><i class="fa fa-level-up m-r-5"></i><small><?php echo $total_income*0,100/100; ?>% higher</small></div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-warning color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong"><?php echo $total_kredit*1/100; ?> k</h2>
                    <div class="m-b-5">KREDIT</div><i class="ti-bar-chart widget-stat-icon"></i>
                    <div><i class="fa fa-level-up m-r-5"></i><small><?php echo $total_kredit*0,100/100; ?>% higher</small></div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-danger color-white widget-stat">
                <div class="ibox-body">
                    <?php $saldo = $total_income - $total_kredit ?>
                    <h2 class="m-b-5 font-strong"><?php echo $saldo *1/100; ?> k</h2>
                    <div class="m-b-5">SALDO</div><i class="fa fa-money widget-stat-icon"></i>
                    <div><i class="fa fa-level-up m-r-5"></i><small><?php echo $saldo*0,100/100; ?>% higher</small></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="ibox-body">
                    ...
                    <table class="table table-striped m-t-20 visitors-table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img class="m-r-10" src="<?php echo base_url('assets/admin/') ?>img/flags/us.png" />USA</td>
                                <td>755</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="<?php echo base_url('assets/admin/') ?>img/flags/Canada.png" />Canada</td>
                                <td>700</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="<?php echo base_url('assets/admin/') ?>img/flags/India.png" />India</td>
                                <td>410</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="<?php echo base_url('assets/admin/') ?>img/flags/Australia.png" />Australia</td>
                                <td>304</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="<?php echo base_url('assets/admin/') ?>img/flags/Singapore.png" />Singapore</td>
                                <td>203</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="<?php echo base_url('assets/admin/') ?>img/flags/uk.png" />UK</td>
                                <td>202</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="<?php echo base_url('assets/admin/') ?>img/flags/UAE.png" />UAE</td>
                                <td>180</td>
                                <td>
                                    <div class="progress">
                    ...
                    <ul class="media-list media-list-divider m-0">
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img class="img-circle" src="<?php echo base_url('assets/admin/') ?>img/users/u1.jpg" width="40" />
                            </a>
                        ...
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img class="img-circle" src="<?php echo base_url('assets/admin/') ?>img/users/u2.jpg" width="40" />
                            </a>
                            <div class="media-body">
                        ...
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img class="img-circle" src="<?php echo base_url('assets/admin/') ?>img/users/u3.jpg" width="40" />
                            </a>
                            <div class="media-body">
                        ...
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img class="img-circle" src="<?php echo base_url('assets/admin/') ?>img/users/u6.jpg" width="40" />
                            </a>
                            <div class="media-body">
            ...
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <ul class="media-list media-list-divider m-0">
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img src="<?php echo base_url('assets/admin/') ?>img/image.jpg" width="50px;" />
                            </a>
                            <div class="media-body">
