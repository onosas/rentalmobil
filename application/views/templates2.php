...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/template/') ?>css/shop.css" class="color-switcher-link">
...
<body>
	...
	<div class="modal fade" id="modalSignupForm" tabindex="-1" role="dialog" aria-labelledby="modalSignupForm" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="row c-gutter-0">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span>×</span>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form role="form" method="POST" action="<?php echo base_url('auth') ?>">
								...
								<div class="modal-password">
									<a href="#" class="modal-password-btn">Login?</a>
								</div>
								<div class="modal-footer d-flex justify-content-center">
									<button type="submit" class="btn btn-small btn-maincolor log-btn">Daftar Sekaranf</button>
								</div>
							</form>
						</div>
					</div>
